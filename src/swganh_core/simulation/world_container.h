...
public:
	...
	int32_t __InternalInsert(std::shared_ptr<swganh::object::Object> object, glm::vec3 new_position, int32_t arrangement_id=-2) { std::cout << "WorldContainer::__InternalInsert" << std::endl; return -2; }
